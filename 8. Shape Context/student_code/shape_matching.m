...
nbBins_theta = 12;
nbBins_r = 5;
smallest_r = 1/8;%length of the smallest radius
biggest_r = 3;%length of the biggest radius 
maxIterations = 6;
...
while currentIteration <= maxIterations
   ...
   %set lambda here, just like explained in the assignment, the square of the mean distance between two target points  
   temp = real(sqrt(dist2(Y,Y)));
   mean_dist = mean2(temp(:));
   lambda = mean_dist^2;  
